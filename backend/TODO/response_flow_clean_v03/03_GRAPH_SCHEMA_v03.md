...
# Схема графа Neo4j v3

**Дата обновления:** 2025-11-18
**Статус:** Спецификация для реализации
**Версия:** 3.0 (No-Cache & Constructive Interaction)

---

## Введение

Схема v3 построена на принципе **"Связи как источник истины"**. Мы не храним ID проектов внутри заметок и статусы внутри сущностей. Вся логика системы строится на навигации по ребрам графа.
...
**Следующий документ:** [04_LANGGRAPH_WORKFLOW_V2.md](./04_LANGGRAPH_WORKFLOW_V2.md)