"""
PARA Entity Types - LLM-Optimized Custom Entities for Graphiti

This module defines high-level PARA (Projects, Areas, Resources, Archive) entity types
...
Usage:
    ...
    from app.config.para_config import PARA_ENTITY_TYPES

    # Pass to Graphiti during note processing
